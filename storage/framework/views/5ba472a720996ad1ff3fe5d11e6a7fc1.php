...
<head>
    ...
    <title><?php echo e($portal->Judul); ?></title>
...
<header id="main-navbar" class="fixed top-0 left-0 w-full h-[80px] z-50 bg-transparent transition-all duration-300 border-b border-transparent">
    ...
    <section class="relative w-full h-[65vh] md:h-[80vh] flex items-center justify-center overflow-hidden bg-primary">
        <div class="relative z-10 flex flex-col items-center px-6 text-center max-w-5xl">
            <span
                class="inline-block <?php echo e($badgeColor); ?> py-2 px-6 rounded-lg text-sm font-bold uppercase tracking-widest mb-6 shadow-xl">
                <?php echo e($portal->Kategori); ?>

            </span>
            <h1 class="text-4xl md:text-6xl font-bold leading-tight mb-10 drop-shadow-2xl">
                <?php echo e($portal->Judul); ?>

            </h1>
            <div class="flex items-center gap-4 text-left mb-14 md:mb-0">
                <img src="<?php echo e(filled($portal->foto_penulis) && file_exists(public_path('storage/' . $portal->foto_penulis)) ? asset('storage/' . $portal->foto_penulis) : asset('img/author.webp')); ?>"onerror="this.onerror=null;this.src='<?php echo e(asset('img/logo_putih.webp')); ?>';"
                    class="w-12 h-12 rounded-full border-2 border-white/20" />
                <div class="flex flex-col leading-tight">
                    <p class="font-bold text-lg"><?php echo e($portal->Penulis); ?></p>
                    <p class="text-gray-400 text-sm">
                        <?php echo e($portal->created_at->format('d F Y')); ?> <span class="mx-1">•</span> <i
                            class="far fa-eye"></i> <?php echo e($portal->view ?? 0); ?>
    ...
    <main class="relative z-10 bg-secondary pb-20">
        <section class="flex justify-center px-4">
            <div class="max-w-5xl mx-auto px-6 -mt-24 relative z-20">
                <div class="rounded-[24px] overflow-hidden shadow-2xl border border-white/5">
                    <img src="<?php echo e(asset('storage/' . $portal->Gambar)); ?>" class="w-full object-cover">
                </div>
            </div>
        </section>
        ...
        <section
            ...
            <div class="flex flex-col">
                <p class="text-xl font-bold text-white"><?php echo e($portal->Penulis); ?></p>
                <p class="italic text-gray-400 text-lg leading-relaxed">
                    "<?php echo e($portal->Quote); ?>"
                </p>
            </div>
        </section>
        ...
        <section class=" px-12 md:px-20 pt-12 pb-48">
            ...
            <div>
                <div class="flex flex-wrap justify-center gap-9 mt-12">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $rekomendasi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        <?php
                            $colorMap = [
                                'ALAM' => 'text-alam',
                        ...
                        <a href="<?php echo e(route('portal.show', $item->slug)); ?>" class="block">
                            <div class="w-96 flex-shrink-0 flex flex-col gap-3 snap-center">
                                <img src="<?php echo e(asset('storage/' . $item->Gambar)); ?>"
                                    class="w-full aspect-[16/9] object-cover rounded-lg" alt="<?php echo e($item->Judul); ?>">

                                <p class="<?php echo e($kategoriColor); ?> font-bold">
                                ...
                                <p class="text-gray-500 text-sm"><?php echo e($item->Penulis); ?>
...
<?php /**PATH C:\Users\contd\.vscode\cli\Laravel\Mayung-Media\resources\views/berita.blade.php ENDPATH**/ ?>